...
// ==============================================
// This file contains interfaces that complement the existing specific interfaces
// and provide common patterns used across the application

/**
 * Standard API Response wrapper (for endpoints that return wrapped responses)
 */
...
/**
 * API call state for loading management in components
 */
...
/**
 * Generic service response with loading state
 */
